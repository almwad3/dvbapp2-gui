...
EGAddonInfo_Skin = """
		<screen name="EGAddonInfo" position="center,center" size="820,550" title="EGAMI Addon Informations">
			...
			<ePixmap name="border" pixmap="egami_icons/div-h.png" position="10,385" size="800,4"/>
...
EG_InternetAddons_Skin = """
		<screen name="EG_InternetAddons" position="center,center" size="620,550" title="EGAMI Management Addons - Internet Addons" >
			<ePixmap name="border" pixmap="egami_icons/div-h.png" position="10,45" size="800,4"/>
			...
			<ePixmap name="border" pixmap="egami_icons/div-h.png" position="10,485" size="800,4"/>
			<ePixmap position="30,509" zPosition="0" size="35,25" pixmap="egami_icons/buttons/button_red.png" transparent="1" alphatest="on" />
			<widget name="key_red" position="65,509" size="200,25" font="Regular;18"/>
			<ePixmap position="430,509" zPosition="0" size="35,25" pixmap="egami_icons/buttons/button_blue.png" transparent="1" alphatest="on" />
...
AddonManager_Skin = """
		<screen name="AddonManager" position="center,center" size="360,270" title="EGAMI Management Addons" >
			...
			<ePixmap pixmap="egami_icons/div-h.png" position="10,70" size="340,4"/>
			<ePixmap pixmap="egami_icons/div-h.png" position="10,120" size="340,4"/>
		</screen>"""
...
EGSwapManager_Skin = """
		   <screen name="EGSwapManager" position="center,center" size="570,350" title="EGAMI Swap File Manager" >
			      ...
			      <ePixmap name="key_red_png" pixmap="egami_icons/buttons/button_red.png" position="10,320" size="140,40" alphatest="on" />
			      ...
			      <ePixmap name="key_green_png" pixmap="egami_icons/buttons/button_green.png" position="150,320" size="140,40" alphatest="on" />
			      ...
			      <ePixmap name="key_yellow_png" pixmap="egami_icons/buttons/button_yellow.png" position="300,320" size="140,40" alphatest="on" />
			      ...
			      <ePixmap name="key_blue_png" pixmap="egami_icons/buttons/button_blue.png" position="450,320" size="140,40" alphatest="on" />
...
EGDeviceManager_Skin = """
		      <screen name="EGDeviceManager" position="center,center" size="800,560" title="EGAMI Devices Manager">
			      ...
			      <widget name="key_red_png" pixmap="egami_icons/buttons/button_red.png" position="40,524" size="140,40" alphatest="on" />
			      ...
			      <widget name="key_green_png" pixmap="egami_icons/buttons/button_green.png" position="210,524" size="140,40" alphatest="on" />
			      ...
			      <widget name="key_yellow_png" pixmap="egami_icons/buttons/button_yellow.png" position="360,524" size="140,40" alphatest="on" />
			      ...
			      <widget name="key_blue_png" pixmap="egami_icons/buttons/button_blue.png" position="510,524" size="140,40" alphatest="on" />
...
EGDeviceManager_Setup_Skin = """
		  <screen name="EGDeviceManager_Setup" position="center,center" size="902,340" title="EGAMI Devices Manager - Setup">
			  ...
			  <ePixmap pixmap="egami_icons/buttons/button_red.png" position="200,300" size="140,40" alphatest="on"/>
			  <ePixmap pixmap="egami_icons/buttons/button_green.png" position="550,300" size="140,40" alphatest="on"/>
...
EGHDDParm_Skin = """
		<screen name="EGHDDParm" position="center,center" size="520,270" title="EGAMI Hard Drive Setup" >
			<ePixmap name="czerwony" position="20,220" zPosition="1" size="200,40" pixmap="egami_icons/buttons/button_red.png" transparent="1" alphatest="on" />
			<ePixmap name="zielony" position="190,220" zPosition="1" size="200,40" pixmap="egami_icons/buttons/button_green.png" transparent="1" alphatest="on" />
	    		<ePixmap pixmap="egami_icons/div-h.png" position="10,160" size="500,4" />
...
EGHardDriveInfo_Skin = """
		<screen name="HardDriveInfo" position="center,center" size="380,290" title="EGAMI IDE Drive Info" >
	    		...
	    		<ePixmap pixmap="egami_icons/div-h.png" position="10,46" size="360,4" />
	    		<ePixmap pixmap="egami_icons/div-h.png" position="10,121" size="360,4" />
    		</screen>"""
...
EGDjMountConfigRoot_Skin = """
		<screen name="EGDjMountConfigRoot" position="center,center" size="540,460" >
			...
			<widget name="red" position="0,415" zPosition="1" size="135,40" pixmap="egami_icons/buttons/button_red.png" transparent="1" alphatest="on" />
			...
			<widget name="green" position="135,415" zPosition="1" size="135,40" pixmap="egami_icons/buttons/button_green.png" transparent="1" alphatest="on" />
...
EGSyslogDConfig_Skin = """
		    <screen name="EGSyslogDConfig" position="center,center" size="570,450" title="EGAMI Syslogd and Klogd Setup" >
			      ...
			      <ePixmap name="key_red_png" pixmap="egami_icons/buttons/button_red.png" position="10,420" size="140,40" alphatest="on" />
			      ...
			      <ePixmap name="key_green_png" pixmap="egami_icons/buttons/button_green.png" position="150,420" size="140,40" alphatest="on" />
			      ...
			      <ePixmap name="key_yellow_png" pixmap="egami_icons/buttons/button_yellow.png" position="300,420" size="140,40" alphatest="on" />
			      ...
			      <ePixmap name="key_blue_png" pixmap="egami_icons/buttons/button_blue.png" position="450,420" size="140,40" alphatest="on" />
...
EGInadyn_Skin = """
		    <screen name="EGInadyn" position="center,center" size="570,370" title="EGAMI Inadyn - dynamic DNS Client" >
			      ...
			      <ePixmap name="key_red_png" pixmap="egami_icons/buttons/button_red.png" position="10,340" size="140,40" alphatest="on" />
			      ...
			      <ePixmap name="key_green_png" pixmap="egami_icons/buttons/button_green.png" position="150,340" size="140,40" alphatest="on" />
			      ...
			      <ePixmap name="key_yellow_png" pixmap="egami_icons/buttons/button_yellow.png" position="300,340" size="140,40" alphatest="on" />
			      ...
			      <ePixmap name="key_blue_png" pixmap="egami_icons/buttons/button_blue.png" position="450,340" size="140,40" alphatest="on" />
...
EGEmuManager_Skin = """
		<screen name="EmuManager" position="center,center" size="780,550" title="EGAMI Blue Panel">
			...
			<ePixmap pixmap="egami_icons/default_cam.png" position="380,8" size="800,60" transparent="1" alphatest="on"/>
			...
			<widget name="ecminfo" position="180,215" size="400,290" font="Regular;18" />
	    		<ePixmap pixmap="egami_icons/div-h.png" position="10,483" size="800,4" />
	    		<ePixmap pixmap="egami_icons/dish_scan.png" zPosition="0" position="30,55" size="200,200" transparent="1" alphatest="on"/>
	    		<ePixmap pixmap="egami_icons/icon_camd.png" zPosition="0" position="20,225" size="200,200" transparent="1" alphatest="on" />
			<ePixmap position="40,504" size="100,40" zPosition="0" pixmap="egami_icons/buttons/button_red.png" transparent="1" alphatest="on"/>
			<ePixmap position="200,504" size="100,40" zPosition="0" pixmap="egami_icons/buttons/button_green.png" transparent="1" alphatest="on"/>
			<ePixmap position="360,504" size="100,40" zPosition="0" pixmap="egami_icons/buttons/button_yellow.png" transparent="1" alphatest="on"/>
			<ePixmap position="550,504" size="100,40" zPosition="0" pixmap="egami_icons/buttons/button_blue.png" transparent="1" alphatest="on"/>
...
EGEmuManagerStarting_Skin = """
		<screen name="EGEmuManagerStarting" position="390,100" size="484,250" title="EGAMI" flags="wfNoBorder">
		    <widget name="starting" position="0,0" size="484,250" zPosition="-1" pixmaps="egami_icons/startcam_1.png,egami_icons/startcam_2.png,egami_icons/startcam_3.png,egami_icons/startcam_4.png,egami_icons/startcam_5.png,egami_icons/startcam_6.png,egami_icons/startcam_7.png,egami_icons/startcam_8.png,egami_icons/startcam_9.png,egami_icons/startcam_10.png,egami_icons/startcam_11.png" transparent="1" />
...
EGEmuInfoScript_Skin = """
		<screen name="EGEmuInfoScript" position="center,center" size="560,405" title="EGAMI EmuInfo Tool" >
			<widget name="list" position="10,10" size="540,280" scrollbarMode="showOnDemand" />
				<ePixmap name="border" pixmap="egami_icons/div-h.png" position="10,290" size="540,4"/>
...
EGDecodingSetup_Skin = """
		<screen name="EGDecodingSetup" position="center,center" size="670,250" title="EGAMI Decoding Setup" >
			...
			<ePixmap name="key_red_png" position="20,220" zPosition="1" size="200,40" pixmap="egami_icons/buttons/button_red.png" transparent="1" alphatest="on" />
			<widget name="key_green" position="310,220" zPosition="2" size="200,20" font="Regular;20" valign="top" halign="left" transparent="1"/>
			<ePixmap name="key_green_png" position="280,220" zPosition="1" size="200,40" pixmap="egami_icons/buttons/button_green.png" transparent="1" alphatest="on" />
		</screen>"""
...
EGInfoBarSetup_Skin = """
		<screen name="EGInfoBarSetup" position="center,center" size="670,550" title="EGAMI Infobar Setup" >
			...
			<ePixmap name="key_red_png" position="20,520" zPosition="1" size="200,40" pixmap="egami_icons/buttons/button_red.png" transparent="1" alphatest="on" />
			<widget name="key_green" position="310,520" zPosition="2" size="200,20" font="Regular;20" valign="top" halign="left" transparent="1"/>
			<ePixmap name="key_green_png" position="280,520" zPosition="1" size="200,40" pixmap="egami_icons/buttons/button_green.png" transparent="1" alphatest="on" />
		</screen>"""
...
EGMountManager_Skin = """
		<screen name="MountManager" position="center,center" size="420,300" title="Mount Manager">
			<ePixmap name="greenbutton" position="0,0" zPosition="1" size="140,40" pixmap="egami_icons/buttons/button_green.png" transparent="1" alphatest="on" />
			<ePixmap name="yellowbutton" position="140,0" zPosition="1" size="140,40" pixmap="egami_icons/buttons/button_yellow.png" transparent="1" alphatest="on" />
			<ePixmap name="bluebutton" position="280,0" zPosition="1" size="140,40" pixmap="egami_icons/buttons/button_blue.png" transparent="1" alphatest="on" />
...
EGSmartScript_Skin = """
		<screen name="SmartScript" position="center,center" size="560,405" title="EGAMI SmartScript Tool" >
			<widget name="list" position="10,10" size="540,280" scrollbarMode="showOnDemand" />
			<ePixmap name="border" pixmap="egami_icons/div-h.png" position="10,365" size="540,4"/>
...
EGFileManagerConfig_Skin ="""
        		<screen name="EGFileManagerConfig" position="center,center" size="650,400" title="EGAMI File Manager - Configuration" >
            			...
            			<ePixmap position="100,358" size="100,40" zPosition="0" pixmap="egami_icons/buttons/button_red.png" transparent="1" alphatest="on"/>
            			<ePixmap position="360,358" size="100,40" zPosition="0" pixmap="egami_icons/buttons/button_green.png" transparent="1" alphatest="on"/>
        		</screen>"""
...
EGFileManager_Skin = """
				...
				<widget name="list_right_text" font="Regular;20" position="575,0" size="150,30"/>
            			...
            			<ePixmap position="20,545" size="80,80" zPosition="1" pixmap="egami_icons/buttons/button_red.png" transparent="1" alphatest="blend" />
            			<widget name="copy_text" zPosition="4" position="50,545" size="140,40" halign="left" valign="top" font="Regular;22" transparent="1" />
            			<ePixmap position="160,545" size="80,80" zPosition="1" pixmap="egami_icons/buttons/button_green.png" transparent="1" alphatest="blend" />
				<widget name="remove_text" zPosition="4" position="190,545" size="140,40" halign="left" valign="top" font="Regular;22" transparent="1" />
				<ePixmap position="320,545" size="80,80" zPosition="1" pixmap="egami_icons/buttons/button_yellow.png" transparent="1" alphatest="blend" />
				<widget name="move_text" zPosition="4" position="350,545" size="140,40" halign="left" valign="top" font="Regular;22" transparent="1" />
				<ePixmap position="470,545" size="80,80" zPosition="1" pixmap="egami_icons/buttons/button_blue.png" transparent="1" alphatest="blend" />
				<widget name="more_text" zPosition="4" position="500,545" size="240,40" halign="left" valign="top" font="Regular;22" transparent="1"  />
				<ePixmap position="740,545" size="80,80" zPosition="1" pixmap="egami_icons/buttons/key_menu.png" transparent="1" alphatest="blend" />
...
EGFileManager_symlink_create_Skin = """
        		<screen name="EGFileManager_symlink_create" position="center,center" size="550,400" title="EGAMI File Manager - New Symlink" >
            			...
            			<ePixmap position="120,360" size="100,40" zPosition="0" pixmap="egami_icons/buttons/button_green.png" transparent="1" alphatest="on"/>
        		</screen>"""
...
EGGreenPanel_Skin = """
		  <screen name="EGGreenPanel" position="center,center" size="700,560" title="EGAMI Green Panel" >
			  ...
			  <ePixmap name="key_red_png" pixmap="egami_icons/buttons/button_red.png" position="20,520" size="140,40" alphatest="on" />
			  <ePixmap name="key_green_png" pixmap="egami_icons/buttons/button_green.png" position="200,520" size="140,40" alphatest="on" />
			  <ePixmap name="key_yellow_png" pixmap="egami_icons/buttons/button_yellow.png" position="370,520" size="140,40" alphatest="on" />
			  <ePixmap name="key_blue_png" pixmap="egami_icons/buttons/button_blue.png" position="550,520" size="140,40" alphatest="on" />
...
EGUsbWifiTuner_Skin = """
		      <screen name="EGUsbWifiTuner" position="center,center" size="800,560" title="EGAMI Wifi and USB Tuners Dongles Setup">
			      ...
			      <widget name="key_red_png" pixmap="egami_icons/buttons/button_red.png" position="60,524" size="140,40" alphatest="on" />
			      <widget name="key_blue_png" pixmap="egami_icons/buttons/button_blue.png" position="600,524" size="140,40" alphatest="on" />
...
EGServices_Skin = """
		<screen name="EGServices" position="center,center" size="450,385" title="EGAMI Daemons / Services Manager" >
			...
			<widget name="key_yellow_big_png" position="20,340" size="200,40" pixmap="egami_icons/buttons/button_yellow.png" alphatest="on" />
			<widget name="key_blue_big_png" position="230,340" size="200,40" pixmap="egami_icons/buttons/button_blue.png" alphatest="on" />
...
EGAMIBackupPanel_Skin = """
		<screen name="EGAMIBackupPanel" position="center,center" size="902,380" title="EGAMI Image Backup Panel - STEP 1" >
		      ...
		      <ePixmap pixmap="egami_icons/buttons/yellow.png" position="72,290" size="140,40" alphatest="on" />
		      <ePixmap pixmap="egami_icons/buttons/blue.png" position="284,290" size="140,40" alphatest="on" />
...
EGAMIBackupPanel_Step2_Skin = """
		<screen name="EGAMIBackupPanel_Step2" position="center,center" size="902,380" title="EGAMI Backup Location - STEP 2">
		      ...
		      <ePixmap pixmap="egami_icons/buttons/yellow.png" position="200,340" size="140,40" alphatest="on"/>
		      <ePixmap pixmap="egami_icons/buttons/green.png" position="550,340" size="140,40" alphatest="on"/>
...
EGAMIBackupPanel_Step3_Skin = """
		<screen name="EGAMIBackupPanel_Step3" position="center,center" size="484,250" title="EGAMI Backup in progress..." flags="wfNoBorder">
		      <widget name="status" position="0,0" size="484,250" zPosition="-1" pixmaps="egami_icons/backup_1.png,egami_icons/backup_2.png,egami_icons/backup_3.png,egami_icons/backup_4.png,egami_icons/backup_5.png,egami_icons/backup_6.png"  />
...
EGAMIRestorePanel_Step1_Skin = """	
		<screen name="EGAMIRestorePanel_Step1" position="center,center" size="902,550" title="EGAMI Backup Restore - STEP 1">
		      ...
		      <ePixmap pixmap="egami_icons/buttons/blue.png" position="380,510" size="140,40" alphatest="on"/>
		      ...
		      <ePixmap pixmap="egami_icons/buttons/green.png" position="550,510" size="140,40" alphatest="on"/>
...
EGAMIRestorePanel_Step2_Skin = """
	      <screen name="EGAMIRestorePanel_Step2" position="center,center" size="484,250" title="EGAMI Restore in progress..." flags="wfNoBorder">
		    <widget name="status" position="0,0" size="484,250" zPosition="-1" pixmaps="egami_icons/restore_1.png,egami_icons/restore_2.png,egami_icons/restore_3.png,egami_icons/restore_4.png,egami_icons/restore_5.png,egami_icons/restore_6.png"  />
		    <widget name="label" position="0,200" halign="center" size="484,60" zPosition="1" font="Regular;20" valign="top" transparent="1" />
	      </screen>"""
