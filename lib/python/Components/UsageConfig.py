...
def InitUsageConfig():
	...
	config.epgselection.infobar_prevtimeperiod = ConfigInteger(default = 300, limits = (60, 300))
	...
	config.epgselection.graph_prevtimeperiod = ConfigInteger(default=180, limits = (60, 300))
