...
def EgamiBootExtract(source, target):
    ...
    if (os.path.exists(sourcefile2) is True):
	  ...
	  if (getKernelVersionString()=="2.6.37"):
	    ...
	    rc = os.system('insmod /usr/lib/enigma2/python/Plugins/Extensions/EGAMIBoot/nandsim_2.6.37.ko cache_file=/media/egamiboot/image_cache first_id_byte=0x20 second_id_byte=0xaa third_id_byte=0x00 fourth_id_byte=0x15;sleep 5')
	  elif (getKernelVersionString()=="3.2.2"):
	    print "Found Kernel 3.2.2"
	    rc = os.system('insmod /usr/lib/enigma2/python/Plugins/Extensions/EGAMIBoot/nandsim_3.2.2.ko cache_file=/media/egamiboot/image_cache first_id_byte=0x20 second_id_byte=0xaa third_id_byte=0x00 fourth_id_byte=0x15;sleep 5')
	  elif (getKernelVersionString()=="3.6.0"):
	    print "Found Kernel 3.6.0"
	    rc = os.system('insmod /usr/lib/enigma2/python/Plugins/Extensions/EGAMIBoot/nandsim_3.6.0.ko cache_file=/media/egamiboot/image_cache first_id_byte=0x20 second_id_byte=0xaa third_id_byte=0x00 fourth_id_byte=0x15;sleep 5')
