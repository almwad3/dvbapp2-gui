...
class MeteoMain(Screen):
    skin = '''<screen position="center,center" size="1280,720" title="Weather" flags="wfNoBorder">
	  <ePixmap position="0,0" size="1280,720" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/AccuWeather/weather/100.png" />
    ...
    def updateInfo(self):
        ...
        try:
            ...
            if dom:
                ...
                icon = '/usr/lib/enigma2/python/Plugins/Extensions/AccuWeather/weather/%s.png' % str(weather_data['condition']['code'])
                ...
                icon = '/usr/lib/enigma2/python/Plugins/Extensions/AccuWeather/weather/small/%s.png' % str(weather_data['forecasts'][0]['code'])
                myicon = self.checkIcon(icon)
                ...
                icon = '/usr/lib/enigma2/python/Plugins/Extensions/AccuWeather/weather/small/%s.png' % str(weather_data['forecasts'][1]['code'])
                myicon = self.checkIcon(icon)
                png = loadPic(myicon, 100, 100, 0, 0, 0, 0)
...
def menu(menuid, **kwargs):
	if menuid == "mainmenu":
		return [(_("Weather"), main, "weather", 1)]
	return []
