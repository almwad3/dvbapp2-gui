	...
	def setLang(self):
		if self.lang == 'de_DE':
			...
			self.keys_list = [
				...
				[u"<", u"э", u"я", u"ч", u"с", u"м", u"и", u"т", u",", ".", u"-", u"ALL"],
				[u"SHIFT", u"SPACE", u"@", u"ь", u"ю", u"ъ", u"OK", u"LEFT", u"RIGHT"]]
			self.shiftkeys_list = [
				[u"EXIT", u"!", u'"', u"§", u"$", u"%", u"&", u"/", u"(", u")", u"=", u"BACKSPACE"],
				...
				[u"SHIFT", u"SPACE", u"?", u"\\", u"Ь", u"Б", u"Ю",  u"Ъ", u"OK", u"LEFT", u"RIGHT"]]
